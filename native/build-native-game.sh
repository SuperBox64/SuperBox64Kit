...
implemented = {
    ...
    "img_by_name", "img_width", "img_height", "gfx_draw_image", "gfx_draw_sprite", "gfx_free_image",
    ...
    "gfx_draw_text", "gfx_draw_text_xform", "gfx_draw_shadow_image", "gfx_set_shadow", "gfx_clear_shadow",
